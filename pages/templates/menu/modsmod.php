...
<div class="menu-one-box smod-box mod-box">
    ...
    <div class="menu-one-box-body">
        ...
        <a class="menu-one-item" href="<?php echo $config->mLink ?>?mode=manage">List all (thuộc quyền)</a>
        <a class="menu-one-item" href="<?php echo $config->mLink ?>?mode=new">Add new</a>
    </div>
</div>
